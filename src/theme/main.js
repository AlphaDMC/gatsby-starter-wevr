...
// const ChartCustom = require('./chart-custom');
const ChatDialogue = require('./chat-dialogue');
// const FullCalendarCustom = require('./fullcalendar-custom');
...
$(function() {
    ...
    // 6. Boards 
    if($('.c-board').length) {
         dragula( $('.c-board__content').toArray(), {});
    }
